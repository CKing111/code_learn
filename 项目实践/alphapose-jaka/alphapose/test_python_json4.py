...
# cmd = ['python','/home/cxking/AlphaPose/scripts/demo_inference_test2.py',' --cfg ','/home/cxking/AlphaPose/configs/coco/resnet/256x192_res50_lr1e-3_2x-dcn.yaml ','--checkpoint ','/home/cxking/AlphaPose/pretrained_models/fast_dcn_res50_256x192.pth ','--outdir',' /home/cxking/AlphaPose/examples/res ','--vis ','--webcam',' 0']
alphapose_cmd = ['python /home/cxking/AlphaPose/scripts/demo_inference_test2.py --cfg /home/cxking/AlphaPose/configs/coco/resnet/256x192_res50_lr1e-3_2x-dcn.yaml --checkpoint /home/cxking/AlphaPose/pretrained_models/fast_dcn_res50_256x192.pth --outdir /home/cxking/AlphaPose/examples/res --vis --webcam 0']
ros_cmd=['roscore']
