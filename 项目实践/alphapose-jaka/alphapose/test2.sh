...
do
    ...
    # sleep 10s
    # #读取结果文件
    # slope=$(cat /home/cxking/AlphaPose/examples/res/test/programing.txt)
    # echo $slope

    sleep 20s
    {
        gnome-terminal -t "roscall-move" -x bash -c "./test_arm_move.sh;exec bash"
    }
    # {
    #     gnome-terminal -t "roscall" -x bash -c "
    #     rosservice call /robot_driver/move_joint "pose: [2.346557885806249, $slope, -0.031926825257684026, 1.6377367646215473, 3.29039844590268, -0.7121641635894775]
    #     has_ref: false
    #     ref_joint: [0]
    #     mvvelo: 0.1
    #     mvacc: 0.3
