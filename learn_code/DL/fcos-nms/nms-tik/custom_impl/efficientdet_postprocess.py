...
class EfficientdetPostprocess():
    ...
    def cal_coord(self, input_data, output_data, anchor_data, coord_ub,
        ...
        input_offset = self.tik_instance.Scalar("int32")
        ...
        self.tik_instance.data_move(coord_ub, input_data[input_offset],
                                    0, 1, loop_length_align_16, 1, 1)
        self.tik_instance.vsub(128, tmp0_ub, anchor1_ub, anchor0_ub,
                               loop_length_align_128, 1, 1, 1, 8, 8, 8)
        self.tik_instance.vexp(128, tmp1_ub, coord_ub, 
                               loop_length_align_128, 1, 1, 8, 8)
        self.tik_instance.vmul(128, tmp1_ub, tmp1_ub, tmp0_ub,
                               loop_length_align_128, 1, 1, 1, 8, 8, 8)

        input_offset.set_as((coord_flag) * self.all_element + offset)
        self.tik_instance.data_move(coord_ub, input_data[input_offset],
                                    0, 1, loop_length_align_16, 1, 1)
        self.tik_instance.vmul(128, coord_ub, coord_ub, tmp0_ub,
                               loop_length_align_128, 1, 1, 1, 8, 8, 8)
